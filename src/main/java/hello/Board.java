...
public class Board {
    ...
    private void addRegions() {
        ...
        regions.add(new Region("g8", "Eastern USA", returnRandomIntRange(20000, 10000), returnRandomIntRange(10000, 1000)));
        regions.add(new Region("g9", "Central USA", returnRandomIntRange(20000, 10000), returnRandomIntRange(10000, 1000)));
        regions.add(new Region("g10", "Western USA", returnRandomIntRange(20000, 10000), returnRandomIntRange(10000, 1000)));
        regions.add(new Region("g11", "Southern USA", returnRandomIntRange(20000, 10000), returnRandomIntRange(10000, 1000)));
